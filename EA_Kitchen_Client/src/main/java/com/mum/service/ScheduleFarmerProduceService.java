...
public class ScheduleFarmerProduceService {
	...
	public void saveScheduleFarmerProduceByIdAndQuantity(int scheduleProduceId,int quantity,int farmerId){
		MultiValueMap<String, String> map = new LinkedMultiValueMap<String, String>();
		map.add("scheduleProduceId", scheduleProduceId+"");
		map.add("farmerId", farmerId+"");
		map.add("quantity", quantity+"");
		restTemplate.postForObject(ScheduleFarmerProduceURL, map, ScheduleFarmerProduce.class);
